...
# ####################
# S-OEE FGP-rOEE P-DQC (CE) P-DQC (PA) WBCP AutoComm DQTetris (PA)
...
# S-OEE FGP-rOEE P-DQC (PA) WBCP AutoComm DQTetris (PA)
...
# S-OEE P-DQC (PA) WBCP AutoComm DQTetris (PA)
...
# S-OEE FGP-rOEE P-DQC (CE) WBCP AutoComm DQTetris (CE)
python main.py -core 22 -cap 20 -cname ising_n420 -nq 420
python main.py -core 5 -cap 10 -cname DraperQFTAdder -nq 50

# ####################
# Evaluation on the gate set {CRZ, RZ, H}
# ####################
# S-OEE FGP-rOEE WBCP AutoComm DQTetris (PA)
python main.py -core 2 -cap 10 -cname QV -nq 20 -gset crz,rz,h
python main.py -core 3 -cap 10 -cname QV -nq 30 -gset crz,rz,h
python main.py -core 4 -cap 10 -cname QV -nq 40 -gset crz,rz,h
python main.py -core 5 -cap 10 -cname QV -nq 50 -gset crz,rz,h
python main.py -core 6 -cap 10 -cname QV -nq 60 -gset crz,rz,h
python main.py -core 7 -cap 10 -cname QV -nq 70 -gset crz,rz,h
python main.py -core 8 -cap 10 -cname QV -nq 80 -gset crz,rz,h
python main.py -core 9 -cap 10 -cname QV -nq 90 -gset crz,rz,h
python main.py -core 10 -cap 10 -cname QV -nq 100 -gset crz,rz,h
python main.py -core 11 -cap 10 -cname QV -nq 110 -gset crz,rz,h
python main.py -core 12 -cap 10 -cname QV -nq 120 -gset crz,rz,h
# S-OEE WBCP AutoComm DQTetris (PA)
python main.py -core 13 -cap 10 -cname QV -nq 130 -gset crz,rz,h
python main.py -core 14 -cap 10 -cname QV -nq 140 -gset crz,rz,h
python main.py -core 15 -cap 10 -cname QV -nq 150 -gset crz,rz,h
python main.py -core 16 -cap 10 -cname QV -nq 160 -gset crz,rz,h

# ####################
# Evaluation on sparse networks
# ####################
# S-OEE P-DQC (PA) WBCP DQTetris (PA)
python main.py -core 2 -cap 100 -cname QV -nq 200 -net mesh
python main.py -core 4 -cap 50 -cname QV -nq 200 -net mesh
python main.py -core 6 -cap 34 -cname QV -nq 200 -net mesh
python main.py -core 8 -cap 26 -cname QV -nq 200 -net mesh
python main.py -core 10 -cap 20 -cname QV -nq 200 -net mesh
